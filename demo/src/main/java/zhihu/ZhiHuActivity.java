...
public class ZhiHuActivity extends SupportActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (findFragmentByClass(RootFragment1.class) == null){
            ...
            rootFragment1 = findFragmentByClass(RootFragment1.class);
            rootFragment2 = findFragmentByClass(RootFragment2.class);
        }
    }
}
